...
- [x] 中英文隐私政策文稿已创建；公开托管与发布者联系邮箱待确认。
...
- [x] 在 Dashboard 和 README 中提供隐私政策入口；Dashboard 目前指向合并后 `main` 上的文稿。
- [x] 增加针对 Provider 披露和 Dashboard 入口的测试。
- [ ] 确认发布者名称、联系邮箱及托管方式，并发布可供商店使用的稳定 URL。
...
| 阶段                        | 状态   | 证据                                           |
| --------------------------- | ------ | ---------------------------------------------- |
| 0. 发布决策与范围冻结       | 进行中 | 已询问 S3 范围、发布者身份与隐私政策托管       |
| 1. Manifest 与权限收敛      | 待开始 | —                                              |
| 2. 隐私披露与用户同意       | 进行中 | 中英文文稿、UI 披露与入口已完成；公开 URL 待定 |
| 3. 商店元数据与视觉素材     | 待开始 | —                                              |
| 4. 可复现发布打包           | 待开始 | —                                              |
| 5. Chrome 与安全 QA         | 待开始 | —                                              |
