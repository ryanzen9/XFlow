...
- [x] 中英文隐私政策文稿已创建；GitHub Pages 部署待验证。
...
- [ ] 启用 GitHub Pages 并验证两个公开 URL；合并后将 Pages 来源切换到 `main/docs`。
...
| 2. 隐私披露与用户同意       | 进行中 | 中英文文稿、UI 披露与入口已完成；Pages 上线待验证               |
| 3. 商店元数据与视觉素材     | 待开始 | —                                                               |
| 4. 可复现发布打包           | 待开始 | —                                                               |
| 5. Chrome 与安全 QA         | 待开始 | —                                                               |
